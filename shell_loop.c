 ...
 *
 * Return: Returns 0 on success, and 1 on error, or an error code
 */
...
/**
 * find_builtin - it Finds the builtin command
 * @info: thE parameter & and return info struct
 *
 * Return: RETURN -1 if builtin not found,
