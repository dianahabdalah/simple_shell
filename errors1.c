 ...
 * Return: Rturns 0 if no numbers is in string, converted number otherwise
 ...
 * Return: returns 0 if no numbers in a string, converted number otherwise
 *        and -1 on a error
 */
...
/**
 * convert_number - A Converter function,clone of itoa
 * @num: the Number
 * @base: the Base
